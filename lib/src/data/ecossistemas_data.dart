...
const List<Ecossistema> ecossistemasData = [
  Ecossistema(
    ...
    descricao:
        'A maior floresta tropical do mundo, abrigando cerca de 10% de '
        'toda a biodiversidade conhecida do planeta.',
    categoria: 'Floresta',
  ),
  Ecossistema(
    id: 'recife_de_coral',
    ...
    descricao:
        'Ecossistemas marinhos formados por colônias de corais, essenciais '
        'para a vida de milhares de espécies aquáticas.',
    categoria: 'Oceano',
  ),
  Ecossistema(
    id: 'deserto_do_saara',
    ...
    descricao:
        'O maior deserto quente do mundo, com adaptações extremas de fauna '
        'e flora à escassez de água.',
    categoria: 'Deserto',
  ),
  Ecossistema(
    id: 'savana_africana',
    ...
    descricao:
        'Vastas planícies com vegetação rasteira e árvores esparsas, lar de '
        'grandes mamíferos migratórios.',
    categoria: 'Savana',
  ),
  Ecossistema(
    id: 'tundra_artica',
    ...
    descricao:
        'Bioma frio e de baixa vegetação, com solo permanentemente congelado '
        'chamado permafrost.',
    categoria: 'Tundra',
  ),
  Ecossistema(
    ...
    descricao:
        ...
        'marinhos, berçário de diversas espécies.',
    categoria: 'Costeiro',
  ),
  Ecossistema(
    id: 'pantanal',
    ...
    titulo: 'Pantanal',
    descricao:
        'Maior planície alagável do mundo, com ciclos sazonais de cheia e '
        'seca que moldam sua rica biodiversidade.',
  ...
  Ecossistema(
    ...
    descricao:
        'O maior bioma terrestre do mundo, dominado por coníferas e '
        'adaptado a invernos longos e rigorosos.',
    categoria: 'Floresta',
  ),
  Ecossistema(
    id: 'oceano_profundo',
    ...
    descricao:
        'Ambiente sem luz solar direta, com espécies adaptadas a altíssima '
        'pressão e escuridão quase total.',
    categoria: 'Oceano',
  ),
  Ecossistema(
    id: 'cerrado',
    ...
    titulo: 'Cerrado',
    descricao:
        'Savana tropical brasileira, considerada a savana mais biodiversa '
        'do mundo, com solo ácido e vegetação retorcida.',
    categoria: 'Savana',
  ),
];
